...
sound_file sound_table[] = {
  ...
  { cereal_CarControl_HUDControl_AudibleAlert_chimeEngage2, "../assets/sounds/engagedt.wav", false },
  { cereal_CarControl_HUDControl_AudibleAlert_chimeDisengage2, "../assets/sounds/disengaget.wav", false },
